...
import durgaa12 from '../../../assets/durgaa12.jpg'
import templebell from '../../../assets/templebell.png'
import durga2323 from '../../../assets/durga2323.webp'
import durga33 from '../../../assets/durga33.jpg'
import Swiper from 'react-native-swiper'
export const windowWidth = Dimensions.get('window').width;
export const windowHeight = Dimensions.get('window').height;

export default function durga1() {
    return (
        <SafeAreaView style={Styles.contaner}>
            ...
            >
                <Image source={durgaa12} style={Styles.Imagestle} />
                <Image source={durga2323} style={Styles.Imagestle} />
                <Image source={durga33} style={Styles.Imagestle} />
            </Swiper>
        </SafeAreaView>
    )
}
