...
export default function Baala() {
    return (
        <SafeAreaView style={Styles.contanerlabel}>
            <Text style={Styles.textstyl}>तिरुपति बालाजी का संगीत संग्रह</Text>
            <View style={{ alignItems: 'center' }}>
                <Image source={texticonlogo} style={{ height: 20, width: 280, marginVertical: -25, right: 30 }} />
            </View>
        </SafeAreaView>
    )
}
